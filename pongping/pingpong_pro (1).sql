...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Agu 2025 pada 06.42
...
CREATE TABLE `scores` (
  ...
  `winner` varchar(20) NOT NULL DEFAULT 'player',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'febriganteng123', '$2y$10$s9Ur60bS5QS7iqsBP/io8Ow.X58f/1mLMkU3.E4Y/F0sXR6rpVaDa', '2025-08-20 10:58:41');
